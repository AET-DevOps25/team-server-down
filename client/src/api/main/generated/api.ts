...
export const NodeControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        patchNode: async (id: string, updateNodeRequest: UpdateNodeRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const NodeControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchNode(id: string, updateNodeRequest: UpdateNodeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Node>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchNode(id, updateNodeRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const NodeControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        patchNode(id: string, updateNodeRequest: UpdateNodeRequest, options?: RawAxiosRequestConfig): AxiosPromise<Node> {
            return localVarFp.patchNode(id, updateNodeRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class NodeControllerApi extends BaseAPI {
     ...
     * @memberof NodeControllerApi
     */
    public patchNode(id: string, updateNodeRequest: UpdateNodeRequest, options?: RawAxiosRequestConfig) {
        return NodeControllerApiFp(this.configuration).patchNode(id, updateNodeRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const WhiteboardApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        removeCollaborators: async (id: number, removeCollaboratorsRequest: RemoveCollaboratorsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('removeCollaborators', 'id', id)
            // verify required parameter 'removeCollaboratorsRequest' is not null or undefined
            assertParamExists('removeCollaborators', 'removeCollaboratorsRequest', removeCollaboratorsRequest)
            const localVarPath = `/whiteboards/{id}/invitations`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(removeCollaboratorsRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        saveWhiteboardState: async (whiteboardId: number, saveWhiteboardStateRequest: SaveWhiteboardStateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'whiteboardId' is not null or undefined
            ...
            assertParamExists('saveWhiteboardState', 'saveWhiteboardStateRequest', saveWhiteboardStateRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(saveWhiteboardStateRequest, localVarRequestOptions, configuration)
...
export const WhiteboardApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async removeCollaborators(id: number, removeCollaboratorsRequest: RemoveCollaboratorsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeCollaborators(id, removeCollaboratorsRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WhiteboardApi.removeCollaborators']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async saveWhiteboardState(whiteboardId: number, saveWhiteboardStateRequest: SaveWhiteboardStateRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.saveWhiteboardState(whiteboardId, saveWhiteboardStateRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async updateTitle(id: number, title: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export const WhiteboardApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        removeCollaborators(id: number, removeCollaboratorsRequest: RemoveCollaboratorsRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.removeCollaborators(id, removeCollaboratorsRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} whiteboardId 
         ...
         * @throws {RequiredError}
         */
        saveWhiteboardState(whiteboardId: number, saveWhiteboardStateRequest: SaveWhiteboardStateRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.saveWhiteboardState(whiteboardId, saveWhiteboardStateRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates the title of an existing whiteboard.
         * @summary Update title
         ...
         * @throws {RequiredError}
         */
        updateTitle(id: number, title: string, options?: RawAxiosRequestConfig): AxiosPromise<string> {
...
export class WhiteboardApi extends BaseAPI {
     ...
     * @memberof WhiteboardApi
     */
    public removeCollaborators(id: number, removeCollaboratorsRequest: RemoveCollaboratorsRequest, options?: RawAxiosRequestConfig) {
        return WhiteboardApiFp(this.configuration).removeCollaborators(id, removeCollaboratorsRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WhiteboardApi
     */
    public saveWhiteboardState(whiteboardId: number, saveWhiteboardStateRequest: SaveWhiteboardStateRequest, options?: RawAxiosRequestConfig) {
        return WhiteboardApiFp(this.configuration).saveWhiteboardState(whiteboardId, saveWhiteboardStateRequest, options).then((request) => request(this.axios, this.basePath));
    }
