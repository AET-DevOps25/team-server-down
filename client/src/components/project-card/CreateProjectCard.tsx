...
export default function CreateProjectCard({createProject}: CreateProjectCardProps) {
    return (
        <div
        ...
        >
            <div className="aspect-video p-4 flex items-center justify-center">
                <div className="flex flex-col items-center space-y-3">
                    <div
                        className="w-12 h-12 rounded-full bg-gray-100 group-hover:bg-gray-200 flex items-center justify-center transition-colors">
